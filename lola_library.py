...
COMMANDS = [
    ...
    {"id":"/codestring","group":"Android Reader","label":"Code Strings","purpose":"Browse/search redacted strings from DEX, resources and source previews","platform":["Android","Windows","Linux"],"cost":"medium","tools":["python"],"outputs":["android-code-reader.json"]},
    {"id":"/codeview","group":"Android Reader","label":"Code View","purpose":"Browse bounded redacted JADX/source/resource previews for the selected target","platform":["Android","Windows","Linux"],"cost":"medium","tools":["python","jadx recommended"],"outputs":["android-code-reader.json"]},
    ...
    {"id":"/codetransparent","group":"Android Reader","label":"Transparent Code Flow","purpose":"Show source/resource/DEX to URL/API/WebView/crypto relationships without executing target code","platform":["Android","Windows","Linux"],"cost":"medium","tools":["python"],"outputs":["android-code-reader.json"]},
    {"id":"/trace","group":"Android Reader","label":"Code Trace","purpose":"Trace target evidence from APK entry/source to URL/API/host and related findings","platform":["Android","Windows","Linux"],"cost":"medium","tools":["python"],"outputs":["android-code-reader.json"]},
    {"id":"/routes","group":"Android Reader","label":"Routes","purpose":"Show Android components plus API/URL destination routes found in the target","platform":["Android","Windows","Linux"],"cost":"low","tools":["python"],"outputs":["android-code-reader.json"]},
    {"id":"/map","group":"Android Reader","label":"Code Map","purpose":"Logical target map linking APK entries, components, APIs, URLs, hosts and code evidence","platform":["Android","Windows","Linux"],"cost":"medium","tools":["python"],"outputs":["android-code-reader.json"]},
